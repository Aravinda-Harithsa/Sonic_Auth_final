############################################################################################
'''Python script To decode the incoming SOnic sound authentication signals '''
############################################################################################
...
Keys = {
  ...
  "10111101011": "Aravinda Harithsa",
  "11110000110": "Aravinda Harithsa Test 1"
}
...
def authenticate():
    while True:
        ...
        if next1:
            ...
            print("#######################################################################")
            print(" Congratulations Mr : ", x[0] ,"is Sucesfully completed multi factot authentication ")
            print("Authenticated DATE: - ",today)
            print("Authenticated TIME : -",current_time)
            print("#######################################################################")
            sa=''
            s=''
            decoded.clear()
...
processes = [authenticate,process_frames, process_points, process_bits]
threads = []
