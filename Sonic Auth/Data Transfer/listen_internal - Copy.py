...
# This is the top level function which you need to call by passing wave file name 
...
def process_data_final(name):
    ...
    sys.stdout.write("################################################\n" )
    sys.stdout.write("Sonic Auth Service\n" )
    sys.stdout.write("################################################\n" )
    sys.stdout.flush()
...
##############################
    '''Call this function by passing name of the wav file'''
    
process_data_final("Rec1.wav")
